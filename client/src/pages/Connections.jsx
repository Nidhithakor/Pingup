...
const Connections = () => {
  ...
  const dataArray = [
    {label : 'Followers' , value : follwers, icon : Users},
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex max-sm:flex-col gap-2 mt-4">
                      ...
                      {currentTab === "Connections" && (
                        <button onClick={() => navigate(`/messages/${user._id}`)} className="w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-slate-800  active:scale-95 transition cursor-pointer flex items-center jsutify-center gap-1">
